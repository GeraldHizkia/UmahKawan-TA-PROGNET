        ...
        <div
          ...
          <div class="col-md-7 col-sm-12 text-center ftco-animate">
            ...
            <div class="text-center mt-3">
              <a class="btn btn-success btn-lg mr-2" href="https://r.grab.com/g/6-20251104_215549_b96ddd27bcc74af8955f7a4450f42eca_MEXMPS-6-CZLTRRDFARJ1R2" target="_blank" rel="noopener noreferrer">
                <i class="fa-solid fa-bolt"></i>&nbsp;Order via Grab
              </a>
              <a class="btn btn-danger btn-lg" href="https://gofood.link/a/yM9K1UQ" target="_blank" rel="noopener noreferrer">
                <i class="fa-solid fa-utensils"></i>&nbsp;Order via GoFood
              </a>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-12 nav-link-wrap mb-5">
              <div class="nav ftco-animate nav-pills justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">Rujak</a>
                <a class="nav-link" id="v-pills-2-tab" data-toggle="pill" href="#v-pills-2" role="tab" aria-controls="v-pills-2" aria-selected="false">Tipat Cantok</a>
                <a class="nav-link" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3" aria-selected="false">Plecing</a>
              ...
              <div class="tab-content ftco-animate" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
                  <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                      <div class="menu-wrap">
                        <a href="#" class="menu-img img mb-4" style="background-image: url(img/cantok\ lengkap.jpg);"></a>
                        <div class="text">
                ...
                <div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-4-tab">
                  <div class="row">
                    <div class="col-md-4 text-center">
                      <div class="menu-wrap">
                        <a href="#" class="menu-img img mb-4" style="background-image: url(img/img.jpeg);"></a>
                        <div class="text">
