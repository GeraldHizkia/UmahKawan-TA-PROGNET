...
<div class="row">
    ...
    <div class="col-md-12 nav-link-wrap mb-5">
        <div class="nav ftco-animate nav-pills justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link <?php echo $active_class; ?>" 
               id="v-pills-<?php echo $tab_counter; ?>-tab" 
               data-toggle="pill" 
               href="#v-pills-<?php echo $tab_counter; ?>" 
               role="tab" 
               aria-controls="v-pills-<?php echo $tab_counter; ?>" 
    ...
    <div class="col-md-12 d-flex align-items-center">
        <div class="tab-content ftco-animate" id="v-pills-tabContent">
            ...
            <div class="tab-pane fade <?php echo $active_show; ?>" 
                 id="v-pills-<?php echo $content_counter; ?>" 
                 role="tabpanel" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                        <div class="menu-wrap">
                            <a href="#" class="menu-img img mb-4" style="background-image: url(<?php echo htmlspecialchars(getImagePath($product['image_url'])); ?>);"></a>
                            <div class="text">
